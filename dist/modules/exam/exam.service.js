...
let ExamService = class ExamService {
    ...
    findAll(keyword, skip = 0, limit = 10) {
        if (keyword) {
            return (0, rxjs_1.from)(this.examModel
            ...
            return (0, rxjs_1.from)(this.examModel.find({}).skip(skip).limit(limit).exec());
        }
    }
    findById(id) {
        return (0, rxjs_1.from)(this.examModel.findOne({ _id: id }).exec()).pipe((0, rxjs_1.mergeMap)((p) => (p ? (0, rxjs_1.of)(p) : rxjs_1.EMPTY)), (0, rxjs_1.throwIfEmpty)(() => new common_1.NotFoundException(`lesson: $id was not found`)));
    }
    save(data) {
        const createExam = this.examModel.create({
            ...data
        });
    ...
    update(id, data) {
        return (0, rxjs_1.from)(this.examModel
            ...
            .exec()).pipe((0, rxjs_1.mergeMap)((p) => (p ? (0, rxjs_1.of)(p) : rxjs_1.EMPTY)), (0, rxjs_1.throwIfEmpty)(() => new common_1.NotFoundException(`exam: $id was not found`)));
    }
    deleteAll() {
        return (0, rxjs_1.from)(this.examModel.deleteMany({}).exec());
    }
    deleteById(id) {
